...
import { useAddToFinishedReadingMutation, useGetReadingListQuery, useRemoveFromReadingListMutation } from "@/redux/features/user/userApi";
...
export function ReadingBookListTable() {
    ...
    return (
        <>
            <Table>
                {books?.length ? (
                    <TableCaption className="mb-8">A list of your recent marked reading books.</TableCaption>
                ) : (
